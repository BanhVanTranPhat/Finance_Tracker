...
export default function QuickActionModal({ isOpen, onClose, onPick }) {
  ...
  const actions = [
    { id: "expense", label: "Chi tiêu", icon: ArrowDownCircle, color: "text-red-600" },
    { id: "income", label: "Thu nhập", icon: ArrowUpCircle, color: "text-emerald-600" },
    { id: "transfer", label: "Chuyển tiền", icon: ArrowLeftRight, color: "text-indigo-600" },
  ];
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
      <div className="bg-white w-full sm:w-[420px] rounded-t-2xl sm:rounded-2xl p-5">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-gray-800">Bạn muốn tạo gì?</h3>
