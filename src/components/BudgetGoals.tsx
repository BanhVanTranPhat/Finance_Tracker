    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition"
        >
            ...
            return (
              <div key={goal.id} className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <button
                  ...
                  className="w-full bg-purple-50 hover:bg-purple-100 text-purple-600 py-2 rounded-lg font-medium transition flex items-center justify-center gap-2"
                >
