  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-50 flex flex-col">
      ...
      <div className="pt-12 pb-6 px-4">
        <div className="text-center">
          <div className="w-20 h-20 bg-yellow-400 rounded-full flex items-center justify-center mx-auto mb-6">
            <Target className="w-10 h-10 text-yellow-800" />
          </div>
          <h1 className="text-3xl font-bold text-yellow-800 mb-4">
            Chào mừng đến với MoneyFlow
          </h1>
      ...
      <div className="p-6">
        <button
          onClick={onNext}
          className="w-full bg-yellow-400 text-yellow-800 font-bold py-4 rounded-xl hover:bg-yellow-500 transition-colors flex items-center justify-center space-x-2"
        >
